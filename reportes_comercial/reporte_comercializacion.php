<?
	...
	if(($acceso <> 8)and($acceso <> 6)and($acceso <> 5)and($acceso <> 1)){
...
?>
<form action="matriz_comercializacion.php" method="post" name="form1" id="form1">
  <table width="439" border="0">
    ...
    <tr>
      <td>Distribuidor:</td>      
	  <? $sql_dist = mysqli_query($link,"SELECT IdDistribuidor, NombreDistribuidor 
                                        FROM Distribuidores 
                                        WHERE flag = 1 
