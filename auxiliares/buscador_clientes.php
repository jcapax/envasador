...
//	$sel_cliente = mysqli_query($link,"SELECT idCliente, nombreCliente, codigoCliente, nombreCalle, numero, nombreLocal FROM clientes c JOIN calles USING (idCalle) JOIN locales USING (idLocal) WHERE nombreCliente LIKE '$criterio'");
...
<table width="814" border="0">
    <tr bgcolor="#FFCC00" align="center">
      <td width="65">C&oacute;digo</td>
      <td width="319">Nombre Cliente </td>
      <td width="174">Direcci&oacute;n</td>
      <td width="114">Tipo Local</td>
	  <td width="120">Editar</td>
    </tr>
	<? 
			...
			if($procedencia == 1){
				echo "<tr style='font-size:11px'>";
					...
					echo "<td align='center'>";
						echo "<a href='../codificar_clientes.php?id_cliente=$cli&tipoR=E'><img src='../imagenes/editar.gif' border='0'></a>";
					echo "</td>";
				echo "</tr>";
			}
			else{
 				echo "<tr style='font-size:11px'>";
					echo "<td><a href='../comercial.php?cliente=$cli'>$buscador[2]</a></td>";
					echo "<td>$buscador[1]</td>";
					echo "<td>$buscador[3] Nº $buscador[4]</td>";
					echo "<td>$buscador[5]</td>";
					echo "<td align='center'>";
